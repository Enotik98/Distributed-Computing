...
public class TaskB {
    public static void main(String[] args)  {
        try {
            FileWriter fw = new FileWriter("/Users/imac/Desktop/3 course/java/Lab4/src/task_b.txt");
            fw.close();
        } catch (IOException e) {
...
class ThreadGarden extends Thread {
    ...
    private void monitor1() throws IOException {
        FileWriter fw = new FileWriter("/Users/imac/Desktop/3 course/java/Lab4/src/task_b.txt", true);
        garden.lockRead();
        int size = garden.getSize();
